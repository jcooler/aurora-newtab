...
async function exerciseSettings(page, context, evidence, highestPhoto, ledgers) {
  ...
  await page.getByTestId('progress-dialog-backdrop').getByLabel('Name', { exact: true }).fill('Water')
  await page.getByRole('button', { name: 'Save' }).click()
  ...
  await page.getByRole('button', { name: 'Add progress' }).click()
  await page.getByTestId('progress-dialog-backdrop').getByLabel('Name', { exact: true }).fill('Read')
  ...
  await page.getByTestId('progress-dialog-backdrop').getByLabel('Name', { exact: true }).fill('Hydrate')
  ...
  await page.getByRole('textbox', { name: 'Habit name', exact: true }).fill('Morning stretch')
  await page.getByRole('button', { name: 'Save' }).click()
