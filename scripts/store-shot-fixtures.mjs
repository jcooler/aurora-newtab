...
export async function seedStoreShotHero(page) {
  await page.evaluate(async ({ heroConnectorIds }) => {
    ...
    const configs = {
      ...
      jira: { enabled: true, email: 'fixture@example.invalid', apiToken: 'fixture-jira-token', site: 'fixture.atlassian.net', displayName: 'Aurora', views: { assigned: true, dueSoon: true, statusChips: true } },
    ...
    const snapshots = {
      ...
      jira: { fetchedAt: now, scope: await scope('jira', configs.jira), data: { issues: [{ key: 'AUR-200', summary: 'Package the release candidate', status: 'In Progress', url: 'https://fixture.atlassian.net/browse/AUR-200' }, { key: 'AUR-201', summary: 'Inspect Store captures', status: 'To Do', url: 'https://fixture.atlassian.net/browse/AUR-201' }], counts: { 'In Progress': 1, 'To Do': 1 }, dueSoon: [{ key: 'AUR-202', summary: 'Review submission copy', status: 'To Do', due: day, url: 'https://fixture.atlassian.net/browse/AUR-202' }] } },
