...
export const CATALOG_BATCHES = Object.freeze({
  ...
  '2': batch([
    ...
    { id: 'ics', label: 'Calendar', tiers: ['compact', 'standard', 'full', 'docked'] },
...
export const CATALOG_CONTRACTS = Object.freeze({
  ...
  '2': Object.freeze({
    ...
    ics: { compact: 'Next date items', standard: 'Agenda or complete month', full: 'Month and agenda together', docked: 'Next relevant date item' },
