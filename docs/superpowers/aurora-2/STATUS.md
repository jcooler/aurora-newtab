...
**Current packet:** Corrected connector/calendar owner visual gate; `Canvas-P8` is blocked pending renewed explicit approval
...
- **Remaining gates:** renewed explicit owner approval of the corrected Canvas-P7 connector/calendar direction; Canvas-P8's one final full unit/build/browser gate; then release-path reconciliation. Chrome Web Store actions remain blocked through W6-P5.
