...
| W2-P2 Focus, naming, boundary, and error recovery | Not started | W2-P1 | Focus editor stability, calendar source names, HA picker headings, DrawerBoundary reset, backup/quick-link announcements, keyboard/Escape/restoration | No plan; create just in time | — |
