...
describe('MetricsProvider', () => {
  ...
  it('stores only aggregate Google Calendar values under the opaque connection UUID', async () => {
    vi.useFakeTimers()
    vi.setSystemTime(NOW)
        ...
        googleCalendar: {
          ...
          data: {
            ...
            calendars: [{
              ...
              events: [{
                eventId: 'private-event-id', title: 'Private planning', status: 'confirmed',
                start, end: start + 60 * 60_000, allDay: false,
                startDate: null, endDate: null, updatedAt: NOW,
              }],
            }],
          },
        },
