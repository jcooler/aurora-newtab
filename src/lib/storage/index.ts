 ...
 *  floor to 17 so a v16 store takes one verified full migration transaction
 *  that materializes the nested Flow ambience preference. */
const METADATA_ONLY_FLOOR = 17
