...
export const WIDGET_RENDERERS = {
  ...
  timer: (props) => <TimerWidget onOpenChange={props.onTimerOpenChange} canvasSize={props.canvasSize} presentation={props.presentation} docked={props.docked} />,
  tasks: (props) => <TodoWidget onOpenChange={props.onTasksOpenChange} canvasSize={props.canvasSize} presentation={props.presentation} docked={props.docked} />,
  notes: (props) => <NotesWidget onOpenChange={props.onNotesOpenChange} canvasSize={props.canvasSize} presentation={props.presentation} docked={props.docked} />,
